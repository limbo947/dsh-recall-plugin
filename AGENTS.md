...
| `scripts/check-dsh-version.mjs` | dsh 版本巡检（镜像漂移/peer 越界/新版提示三层比对，纯函数有单测）                                                                                                                                                                                                                                                                    | 改巡检              |
...
| `npm run check:dsh`   | dsh 版本巡检（本地 dsh vs reference 镜像、npm 最新 vs peer 范围）  | 发布前；dsh 升级后                        |
